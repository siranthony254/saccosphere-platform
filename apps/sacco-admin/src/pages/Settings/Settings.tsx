          ...
          {isLoading ? (
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="text-sm text-ink">{data.sacco.member_count?.toLocaleString() || '0'}</div>
              </div>

              <div>
                <div className="text-xs text-ink-muted mb-1">Registration fee (KES)</div>
                <div className="text-sm text-ink">{data.settings?.registration_fee ?? '—'}</div>
              </div>
              <div>
                <div className="text-xs text-ink-muted mb-1">Loan multiplier</div>
                <div className="text-sm text-ink">{data.settings?.loan_multiplier ?? '—'}</div>
              </div>
            </div>
          ) : (
