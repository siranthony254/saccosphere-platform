  ...
  return (
    ...
    >
      <View className="py-2.5 px-4 border-b border-border flex-row items-center mb-4">
        ...
        <View className="ml-3">
          <Text className="text-ink text-sm font-semibold">Find a SACCO</Text>
          <Text className="text-ink-faint text-xs">{saccos.length} available</Text>
          <Text className="text-ink-faint text-[10px] mt-1">Tap a SACCO to continue to account creation.</Text>
        </View>
      </View>
      ...
      <Text className="text-ink-faint text-xs font-semibold uppercase tracking-wider mb-2">
        Most popular
      </Text>
