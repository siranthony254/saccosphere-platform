...
export const MOCK_PLATFORM_OVERVIEW: PlatformOverview = {
  ...
  active_saccos_change_this_month: 2,
  total_members_change_this_month: 1200,
...
export const MOCK_ALL_SACCOS: SuperAdminSacco[] = [
  { id:'sacco-001', slug:'stima-sacco', name:'Stima SACCO', sector:'Energy', initials:'ST', color:'#0070ba', sasra_reg_no:'SASRA/DT/001/2006', status:'active', is_active:true, member_count:4821, members_on_app:1284, transaction_volume_mtd_kes:38200000, platform_fee_kes:20000, fee_status:'paid', api_connected:true, health_status:'GOOD', health:'healthy', joined_platform_at:'2022-02-01T00:00:00Z', created_at:'2022-02-01T00:00:00Z', last_transaction_at:'2024-06-28T00:00:00Z' },
  { id:'sacco-002', slug:'unaitas-sacco', name:'Unaitas SACCO', sector:'Community', initials:'UN', color:'#16a085', sasra_reg_no:'SASRA/DT/080/2010', status:'active', is_active:true, member_count:62440, members_on_app:24800, transaction_volume_mtd_kes:94100000, platform_fee_kes:45000, fee_status:'paid', api_connected:true, health_status:'GOOD', health:'healthy', joined_platform_at:'2022-06-01T00:00:00Z', created_at:'2022-06-01T00:00:00Z', last_transaction_at:'2024-06-28T00:00:00Z' },
  { id:'sacco-003', slug:'teachers-sacco', name:'Teachers SACCO', sector:'Education', initials:'TS', color:'#7c3aed', sasra_reg_no:'SASRA/DT/022/2008', status:'active', is_active:true, member_count:28012, members_on_app:9800, transaction_volume_mtd_kes:28900000, platform_fee_kes:30000, fee_status:'paid', api_connected:true, health_status:'GOOD', health:'healthy', joined_platform_at:'2022-03-01T00:00:00Z', created_at:'2022-03-01T00:00:00Z', last_transaction_at:'2024-06-28T00:00:00Z' },
  { id:'sacco-004', slug:'kenya-police-sacco', name:'Kenya Police SACCO', sector:'Government', initials:'KP', color:'#c0392b', sasra_reg_no:'SASRA/DT/045/2012', status:'active', is_active:true, member_count:35200, members_on_app:8400, transaction_volume_mtd_kes:11400000, platform_fee_kes:32000, fee_status:'overdue', api_connected:false, health_status:'API_ISSUE', health:'critical', joined_platform_at:'2023-01-01T00:00:00Z', created_at:'2023-01-01T00:00:00Z', last_transaction_at:'2024-06-25T00:00:00Z' },
  { id:'sacco-005', slug:'imarika-sacco', name:'Imarika SACCO', sector:'Community', initials:'IK', color:'#2980b9', sasra_reg_no:'SASRA/DT/091/2015', status:'active', is_active:true, member_count:18003, members_on_app:4200, transaction_volume_mtd_kes:9600000, platform_fee_kes:15000, fee_status:'paid', api_connected:true, health_status:'REVIEW', health:'warning', joined_platform_at:'2023-04-01T00:00:00Z', created_at:'2023-04-01T00:00:00Z', last_transaction_at:'2024-06-27T00:00:00Z' },
]
